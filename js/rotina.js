...
(function () {
  ...
  function reiniciarQuiz() {
    ...
    salvarEstado();
    renderIntroducao();
    window.setTimeout(() => document.getElementById("descubra-rotina")?.scrollIntoView({ behavior: "smooth", block: "center" }), 40);
  }
